...
apt install -y thunar build-essential git libx11-dev libxft-dev libxinerama-dev xorg dmenu unzip lxpolkit x11-xserver-utils unzip wget pulseaudio alacritty pavucontrol xdg-user-dirs
...
cp dotfiles/Wallpapers/* /home/$username/Pictures/Wallpapers/
